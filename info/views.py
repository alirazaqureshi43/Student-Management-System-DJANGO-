...
def e_sch(request):
    return render(request, 'info/e_sch.html')
def contact(request):
    return render(request, 'info/contact.html')
def dsa_con(request):
    return render(request, 'info/dsa_con.html')
def exam_con(request):
    return render(request, 'info/exam_con.html')
def wa_groups(request):
    return render(request, 'info/wa_groups.html')
#---------------------------------------
@login_required()
