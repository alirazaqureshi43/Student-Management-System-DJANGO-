...
urlpatterns = [
    ...
    path('sch', views.e_sch, name='e_sch'),
    path('contact', views.contact, name='contact'),
    path('wa_groups', views.wa_groups, name='wa_groups'),
    path('dsa_con', views.dsa_con, name='dsa_con'),
    path('exam_con', views.exam_con, name='exam_con'),
